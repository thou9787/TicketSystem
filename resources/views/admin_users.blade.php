                ...
                <div class="container">
                    <form action="{{ url('/user/create') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="role" name="role" placeholder="user, admin">
                        </div>
                        <div class="form-group">
                            <label for="email">Email</label>
                            <input type="text" class="form-control" id="email" name="email" placeholder="123@example.com">
                        </div>
                        <div class="form-group">
                            <label for="password">Password</label>
                            <input type="datetime" class="form-control" id="password" name="password" placeholder="8 charactors at least">
                        </div>
                        <div class="form-group">
            ...
            <table>
                ...
                <tr>
                    <form action="{{ url('/user', ['id' => $user->id]) }}" method="POST">
                        ...
                        <td><input type="text" name="created_at" value="{{ $user->updated_at }}" disabled="disabled" size="17"></td>
                        <td><input type="text" name="created_at" value="{{ $user->updated_at }}" disabled="disabled" size="18"></td>
                    ...
                    <td>
                        <form action="{{ url('/user', ['id' => $user->id])}}">
                            ...
                            <input type="hidden" name="password" value="{{ $user->password }}" disabled="disabled" size="13">
                            <input type="hidden" name="created_at" value="{{ $user->updated_at }}" disabled="disabled" size="13">
                            <input type="hidden" name="created_at" value="{{ $user->updated_at }}" disabled="disabled" size="13">
